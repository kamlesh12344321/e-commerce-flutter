...
class EditFieldName extends StatefulWidget {
  const EditFieldName({super.key, required this.editTextData, required this.onChanged});
  final ValueChanged<String> onChanged;
  final Data editTextData;

  @override
  State<EditFieldName> createState() => _EditFieldNameState();
}

class _EditFieldNameState extends State<EditFieldName> {
  @override
