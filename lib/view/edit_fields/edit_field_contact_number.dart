...
class EditFieldContactNumber extends StatefulWidget {
  final ValueChanged<String> onChanged;

  const EditFieldContactNumber(
      {super.key, required this.editTextData, required this.onChanged});

  final Data editTextData;

  @override
  State<EditFieldContactNumber> createState() => _EditFieldContactNumberState();
}

class _EditFieldContactNumberState extends State<EditFieldContactNumber> {
